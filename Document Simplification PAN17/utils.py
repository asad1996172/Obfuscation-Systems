...
def save_pickle_list(pickle_path, req_list):
    with open(pickle_path + '.pkl', 'wb') as f:
        pickle.dump(req_list, f)


def load_pickle_list(pickle_path):
    with open(pickle_path + '.pkl', 'rb') as f:
        req_list = pickle.load(f)
    return req_list


def create_contractions_markers_pickles():
    contractions = {
        "ain't": "am not",
        "aren't": "are not",
        "can't": "cannot",
    ...
    save_pickle_dict('contraction_extraction', contractions)
